    ...
    return (
        <div className="w-full min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <p className="text-xl md:text-2xl text-white/90 poiret leading-relaxed">
                        ...
                        Started in <span className="text-[#FFD700] font-bold">July 2010</span>, we offer one of the best gym facilities, aerobics and dance classes in Chennai.
                    </p>
                    ...
                    <div className="p-8 glass-card border border-[#FFD700]/10 rounded-3xl backdrop-blur-md relative overflow-hidden group hover:border-[#FFD700]/30 transition-all duration-500">
                        <div className="absolute top-0 left-0 w-1 h-full bg-[#FFD700] opacity-50"></div>
                        <h3 className="text-[#FFD700] text-xl font-black league-spartan mb-3 uppercase tracking-[0.2em]">Our Philosophy</h3>
                ...
                <div className="relative group overflow-hidden rounded-3xl border border-white/10 gold-border-hover shadow-2xl">
                    <img 
            ...
            <div className="mt-24 w-full grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                <div className="p-10 glass-card border border-white/10 rounded-[40px] hover:border-[#FFD700]/50 transition-all duration-500 group shadow-lg hover:shadow-[0_0_30px_rgba(255,215,0,0.1)] hover:-translate-y-2">
                    <h4 className="text-5xl font-black text-[#FFD700] league-spartan mb-2 drop-shadow-[0_0_10px_rgba(255,215,0,0.3)]">10+</h4>
                ...
                <div className="p-10 glass-card border border-white/10 rounded-[40px] hover:border-[#FFD700]/50 transition-all duration-500 group shadow-lg hover:shadow-[0_0_30px_rgba(255,215,0,0.1)] hover:-translate-y-2">
                    <h4 className="text-5xl font-black text-[#FFD700] league-spartan mb-2 drop-shadow-[0_0_10px_rgba(255,215,0,0.3)]">6000</h4>
                ...
                <div className="p-10 glass-card border border-white/10 rounded-[40px] hover:border-[#FFD700]/50 transition-all duration-500 group shadow-lg hover:shadow-[0_0_30px_rgba(255,215,0,0.1)] hover:-translate-y-2">
                    <h4 className="text-5xl font-black text-[#FFD700] league-spartan mb-2 drop-shadow-[0_0_10px_rgba(255,215,0,0.3)]">500+</h4>
