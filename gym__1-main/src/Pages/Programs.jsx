...
const Programs = () => {
    ...
    return (
        <div
            id="programs-section"
            className="w-full min-h-screen pt-24 sm:pt-32 pb-20 px-4 sm:px-6 max-w-7xl mx-auto flex flex-col items-center"
        >
            ...
            <motion.div
                ...
                style={{
                    background:
                        'linear-gradient(145deg, rgba(20,0,0,0.9) 0%, rgba(5,5,5,1) 100%)',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full">
                ...
                {programsList.map((prog, index) => (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-black text-white league-spartan mb-4 uppercase tracking-tighter">
                            {prog.title}
                        </h3>

                        <p className="poiret text-white/50 text-lg leading-relaxed">
                            {prog.description}
                        </p>
            ...
            <AnimatePresence>
                {selectedProgram && (
                    ...
                    >
                        ...
                        >
                            <div className="absolute top-0 left-0 right-0 h-1 rounded-t-3xl bg-gradient-to-r from-transparent via-[var(--primary)] to-transparent" />

                            <div className="text-5xl mb-4 text-[var(--primary)] drop-shadow-[0_0_15px_rgba(255,0,0,0.4)]">
                                {selectedProgram.icon}
                            </div>

                            <h2 className="text-3xl md:text-4xl font-bold league-spartan mb-4 uppercase tracking-tight text-[var(--primary)]">
                            ...
                            <h4 className="text-sm font-bold uppercase tracking-widest league-spartan mb-3 text-[var(--primary)]/80">
                                Benefits
                            </h4>
                            ...
                            <button
                                onClick={() => setSelectedProgram(null)}
                                className="w-full py-3 bg-[var(--primary)] text-black font-bold rounded-xl transition-all league-spartan uppercase tracking-wider cursor-pointer hover:shadow-[0_0_30px_rgba(255,0,0,0.5)]"
                            >
                                Close
                            </button>
